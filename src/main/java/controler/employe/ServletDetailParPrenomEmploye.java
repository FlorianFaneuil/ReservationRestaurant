...
public class ServletDetailParPrenomEmploye extends HttpServlet {
...
//		String idNom = request.getParameter("id");
//
...
//
		...
		try {
			employe = employeBll.selectByPrenom("Sacha");
		...
		request.getRequestDispatcher("/WEB-INF/jsp/connecte/detailParPrenomEmploye.jsp").forward(request, response);
	}
